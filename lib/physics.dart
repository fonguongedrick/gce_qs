...
import 'package:gce_qs/test.dart';
import 'physics_p1.dart';
...
class Physics extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Physics', style: TextStyle(color: Colors.black),),
        centerTitle: true,
        elevation: 0,
