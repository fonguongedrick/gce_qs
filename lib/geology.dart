...
import 'package:gce_qs/geology_p1.dart';
import 'biology_p1.dart';
class Geology extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Geology', style: TextStyle(color: Colors.black),),
        centerTitle: true,
        elevation: 0,
